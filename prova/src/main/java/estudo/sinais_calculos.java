           ...
           System.out.print("\033\143");
            ...
            if(x == 1){
                ...
                if(y.equalsIgnoreCase("s")){
                    ...
                    System.out.println("o resultado do calculo de " + numb + " * " + numb2 + " = " + numb * numb2);
                    System.out.println("");
                    ...
                    System.out.println("O resultado da divisão do número " + numerador + " dividido por " + dividendo + " = " + calcdiv);
                    System.out.println("");
                    System.out.println("Fórmula usada: ");
                    System.out.println("int numerador = entrada.nextint(); ");
                    System.out.println("int dividendo = entrada.nextint(); ");
                    System.out.println("int calcdiv = numerador / dividendo ");
                    ...
                    System.out.println("");
                    if(calcmulti == 0){System.out.println(""); System.out.println("Este número é par"); } else {System.out.println("Este número nao é par");}
                    ...
                    System.out.println("Vamos a mais um exemplo né mesmo? Digite aqui o número no qual deseja tirar raiz quadrada:");
                     ...
                     System.out.println("");
                     System.out.println("O resultado da raiz quadrada de " + numb + " = " + raiz);
                    System.out.println("Fórmula:"); System.out.println("double raiz = Math.sqrt(numb)"); System.out.println("System.out.println(raiz)"); System.out.println(""); //linha de fórmulas
                       //restart
                       System.out.println("deseja continuar?");
                       String y = entrada.next(); 
                       if(y.equalsIgnoreCase("s")){
                ...
                //&&
                    ...
                    System.out.println(" if (x < 5 && x > 3) ---> Nesse código dizemos basicamente que: SE E SOMENTE SE o valor de x for menor que 5 E for maior que 3 o comando if será executado.");
                    System.out.println("");
                //||
                    ...
                    System.out.println("x = 5 || x = 4 ---> Aqui dizemos que x pode ser igual a 5 OU x pode ser igual a 4, portanto pode ser um OU outro, esse comando é extremamente útil para quando queremos colocar duas situações onde as condicionais devem ocorrer, por exemplo: ");
                    System.out.println("if(numb = 5 || numb = 10) ---> Nesse código colocamos duas situações para que a condicional if ocorra, como assim? de forma simples, aqui dizemos que");
                ...
                // !
                    ...
                    System.out.println("if(x < 5){x = !true} ---> Aqui declaramos a variavel boolean, ou melhor uma variavel lógica que serve basicamente para podermos criar laços e loopings usando while e alguns varios outros comandos");
